...
try:
    from solo.config import APP as DBNAME
except Exception:
    pass
try:
    from solo.config import DBNAME
except Exception:
    pass
...
class Doc(Document):
    ...
    def upsert(self, spec, multi=False):
        ...
        # print spec
        # print {'$set': dict((k,v) for k,v in self.iteritems() if v is not
        # None )},
        return self
...
# find_one(self, spec_or_id=None, *args, **kwargs) method of
# mongokit.collection.Collection instance
